var options = {
  ...
  stackedCategoricalBar: require('plugins/phoenix/lib/options/stackedCategoricalBar.js'),
  groupCategoricalBar: require('plugins/phoenix/lib/options/groupCategoricalBar.js'),
